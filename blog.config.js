...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'rkno', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '呢个系本人用于鞭策自己学习gie博客，诸位共勉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rkno.top', // 网站地址
